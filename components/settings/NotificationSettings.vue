<template>
  <div class="space-y-6 sm:space-y-8">
    <div>
      <h2 class="text-xl sm:text-2xl font-bold mb-2" style="color: var(--p-text-color);">Notification Settings</h2>
      <p class="text-sm mb-4 sm:mb-6" style="color: var(--p-text-muted-color, var(--p-text-color-secondary));">
    ...
    <div class="rounded-lg border p-4 sm:p-6" style="background: var(--p-surface-card); border-color: var(--p-surface-border);">
      <div class="flex items-start sm:items-center gap-3 mb-4 sm:mb-6">
        <i class="pi pi-envelope text-xl shrink-0 mt-0.5 sm:mt-0" style="color: var(--p-primary-color);"></i>
        <div class="min-w-0">
          <h3 class="text-base sm:text-lg font-semibold" style="color: var(--p-text-color);">Email Notifications</h3>
    ...
    <div class="rounded-lg border p-4 sm:p-6" style="background: var(--p-surface-card); border-color: var(--p-surface-border);">
      <div class="flex items-start sm:items-center gap-3 mb-4 sm:mb-6">
        <i class="pi pi-mobile text-xl shrink-0 mt-0.5 sm:mt-0" style="color: var(--p-primary-color);"></i>
        <div class="min-w-0">
          <h3 class="text-base sm:text-lg font-semibold" style="color: var(--p-text-color);">SMS Notifications</h3>
    ...
    <!-- Info Note -->
    <div class="flex items-start gap-3 rounded-lg p-3 sm:p-4" style="background: var(--p-highlight-background); color: var(--p-highlight-color);">
